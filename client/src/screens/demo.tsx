...
const DemoScreen = ({
  ...
  useEffect(() => {
    // setShowLoading(true);
    axios
      .get(process.env.REACT_APP_BACKEND_URL + "/interviews/random")
      .then((res) => {
  ...
  const prevInterview = () => {
    if (mainAllInterviews?.length && selectedInterview?.id) {
      const currentIndex = mainAllInterviews.findIndex(
        (i) => i.id === selectedInterview.id
      );
  ...
  return (
    <LinearBackground style={{ width: "100%" }}>
      <div className="pageContainer" style={{ padding: 0, gap: 0 }}>
        <div
          className="leftSideDiv rightSideBg pos-rel over-hdn auth-page bg-transparent"
        ...
        >
          ...
          <div
            className="lkljdfsl-sifkmd carousal-btn"
            style={{ width: "auto", left: 25 }}
            ...
            >
              <g filter="url(#filter0_b_5913_7947)">
                <rect
                  ...
                  height="52.6565"
                  rx="26.3283"
                  transform="rotate(-180 52.6562 52.6562)"
                  fill="#787FBB"
                  fill-opacity="0.2"
                />
                <path
              ...
              <g filter="url(#filter1_b_5913_7947)">
                ...
                />
                <path
                  d="M30.16 32.1073L23.9276 25.9551L30.16 20.5475C30.9016 19.8619 30.9016 18.7512 30.16 18.0656C29.4184 17.3799 28.217 17.3799 27.4754 18.0656L19.8813 24.2354C17.9443 25.9551 17.9469 26.0091 19.8813 27.5684L27.4754 34.5893C28.217 35.2749 29.4184 35.2749 30.16 34.5893C30.9016 33.9037 30.9016 32.7929 30.16 32.1073Z"
                  fill="white"
                />
              </g>
              <defs>
                <filter
                  id="filter0_b_5913_7947"
                  x="-35.1044"
                  y="-35.1044"
                  width="122.865"
                  height="122.865"
                ...
                >
                  ...
                  <feGaussianBlur
                    ...
                    stdDeviation="17.5522"
                  />
                  <feComposite
                    in2="SourceAlpha"
                    operator="in"
                    result="effect1_backgroundBlur_5913_7947"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_backgroundBlur_5913_7947"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_b_5913_7947"
                  x="-35.1044"
                  y="-35.1044"
                  width="122.865"
                  height="122.865"
              ...
              <defs>
                ...
                >
                  ...
                  <feComposite
                    in2="SourceAlpha"
                    operator="in"
                    result="effect1_backgroundBlur_5913_7942"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_backgroundBlur_5913_7942"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_b_5913_7942"
                  x="-34.161"
                  y="-35.1044"
                  width="122.865"
                  height="122.865"
