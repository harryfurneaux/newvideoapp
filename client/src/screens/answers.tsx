    ...
    <div className="pageContainer kladsfhjn-ajwe">
      <div className="jkadshfkjf rightSideDiv rightSideBg1 pos-rel sjfdak-ajwe">
        <div className="leftsidediv">
          {
            showScreen == 0 ? <MainForm setMainScreen={setMainScreen} showScreen={showScreen} setshowScreen={setshowScreen} /> : <><FormMessage showScreen={showScreen} setshowScreen={setshowScreen} /></>
          }
          {
            showScreen == 0 ? <TopSec setMainScreen={setMainScreen} showScreen={showScreen} setshowScreen={setshowScreen} showFilter={showFilter} handleFilterShow={handleFilterShow} handleFilterClose={handleFilterClose} /> : <div className="sjaklsa-wmjes"><Back setMainScreen={setMainScreen} setShowScreen={setshowScreen} /></div>
          }
        </div>
