...
const BeginForm = ({
  ...
  return (
    <div
      className={`kjjfds-janwkea1 kjjfds-janwkea2 white-form height-none ${className}`}
    >
      ...
      <div className="kafms-kfsamfer">
        <div className="skfalk-smdsefds">
          ...
          <div className="kjdflkads-mdskf">
            ...
            <h5>
              <Icons iconNumber={16} />{" "}
              {jobViewContext?.job_recruiter ||
                jobViewContext?.interviewer.company_name}
            </h5>
            <h6>
        ...
        <div className="kdjsa-ajwnkelds afkfjnkas-edsm">
          <div className="continueBtnDiv snasdj-sawdne">
              ...
              onClick={() => {
                if (recorded?.length === jobViewContext?.questions?.length) {
                  ...
                  recorded.forEach((obj: any, index: any) => {
                    ...
                    formData.append(
                      `interviewer`,
                      jobViewContext.interviewer._id
                    );
                    if (user?.id) {
            ...
            >
              {recorded?.length === jobViewContext?.questions?.length
                ? "Submit"
                : recorded?.length
                ? "Next Question"
                : "Begin"}
