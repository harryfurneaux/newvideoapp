...
const VideoForm = ({
  ...
  return (
    <div style={{ position: "relative", marginLeft: 60 }}>
      <div
        className="kjjfds-janwkea4"
        style={{ overflow: "hidden", borderRadius: 23, height: 585 }}
      >
        {/* <img src={require("../../images/i6.png")} /> */}
        <div
          className={`jljdskaflsd d-flex`}
          style={{
            background:
              "linear-gradient(182.61deg, rgba(0, 0, 0, 0.2) -0.73%, rgba(0, 0, 0, 0) 93.15%)",
          }}
        >
        ...
        >
          ...
          >
            <div
              className={`d-flex justify-content-center skdjand-wkemd ksljfsa-asjd`}
              style={
                showPlayPause
                  ? { opacity: "1" }
        ...
        <div className={`kjjsad-awek d-flex`} style={{
          ...
          >
            {muted ? (
              ...
              >
                <g opacity="0.8">
                  <path
                    d="M9.77576 1.125L5.2861 5.03675H1.06055V9.99164H5.2861L9.77576 13.9034V1.125Z"
                    fill="white"
                    stroke="white"
                  ...
                  />
                  <path
                    d="M12.4277 5.70703L15.9992 9.27846M15.9992 5.70703L12.4277 9.27846"
                    stroke="white"
                    stroke-width="1.42857"
                    stroke-linecap="round"
                  />
              ...
              >
                <g opacity="0.8">
                  <path
                    d="M9.71521 0.707031L5.22556 4.61878H1V9.57367H5.22556L9.71521 13.4854V0.707031Z"
                    fill="white"
                    stroke="white"
                    stroke-width="1.34558"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M12.0273 9.2779C12.9149 9.2779 13.6345 8.31851 13.6345 7.13504C13.6345 5.95158 12.9149 4.99219 12.0273 4.99219V9.2779Z"
                    fill="white"
                  />
                  <path
                    d="M12.3398 12.1367C14.4109 12.1367 16.0898 9.89813 16.0898 7.13671C16.0898 4.37529 14.4109 2.13672 12.3398 2.13672"
                    stroke="white"
                    stroke-width="1.42857"
                    stroke-linecap="round"
                  />
          ...
          <div style={{ position: "absolute", bottom: "95px", left: "135px" }}>
            ...
            >
              <circle
                ...
                cy="6"
                r="6"
                fill={paginate == 1 ? "#06FBED" : "white"}
                fill-opacity={paginate == 1 ? "0.8" : "0.5"}
              />
              <circle
                cx="57.5918"
                cy="6"
                r="6"
                fill={paginate == 2 ? "#06FBED" : "white"}
                fill-opacity={paginate == 2 ? "0.8" : "0.5"}
              />
              <circle
                cx="31.7969"
                cy="6"
                r="6"
                fill={paginate == 3 ? "#06FBED" : "white"}
                fill-opacity={paginate == 3 ? "0.8" : "0.5"}
              />
            </svg>
          </div>

          <div className="kdjasldk-ajsdmkd"></div>
              ...
              <div style={{ position: "absolute", right: "12px", top: "15px" }}>
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M8.49998 0.980469C12.6423 0.980469 16 4.33825 16 8.48047C16 12.6227 12.6423 15.9805 8.49998 15.9805C4.35791 15.9805 1 12.6227 1 8.48047C1 4.33825 4.35791 0.980469 8.49998 0.980469Z"
                    fill="black"
                    fill-opacity="0.01"
                    stroke="#ADB8FA"
                    stroke-width="1.25"
          ...
          >
            ...
            <h5 style={{ marginLeft: 10 }}>
              {job?.questions?.length
                ? job?.questions[0]?.question_id?.question
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(0deg, rgba(0, 0, 0, 0.2) -0.73%, rgba(0, 0, 0, 0) 93.15%)",
            }}
          ></div>
        </div>
      </div>
