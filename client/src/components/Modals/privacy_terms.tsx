...
const PrivacyTerms = ({ show, handleClose }: { show: boolean, handleClose: any }) => {
  return (
    ...
    Customer may cancel its account at any time. Before doing so, Company recommends that Customer review these Terms and Conditions carefully so Customer understands what will occur upon cancellation, particularly in relation to payments for Services.
		To effectively cancel Customer’s Account, Customer is required to contact the Company at at @asker.com for assistance. Upon doing so, the cancellation of Customer’s Account will take place promptly.
